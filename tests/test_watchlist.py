...
Tests for the watchlist service. Mirrors the structure of
tests/test_collection.py (same fixtures and assertion style).
"""
...
def test_add_to_watchlist_nonexistent_film_raises(app, sample_user):
    ...
    """
    with app.app_context():
        fake_film_id = "00000000-0000-0000-0000-000000000000"  # no such film
